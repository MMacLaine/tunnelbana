...
const CASES = [
  ...
  // fleet-scaled bill, so the fleet must be past the free allowance. The
  // gate runs at the last era, where the 0.14.0 era-scaled allowance is 14
  // free trains, so the fleet sits at 19 (18 bought plus the starter) to
  // keep the knee binding under measurement.
  { id: 'driftcentral', demand: 'high', base: { drivers: 1, train: 18, timetable: 1 }, buy: { driftcentral: 1 } },
  { id: 'co service', demand: 'high', base: { drivers: 1, train: 18, timetable: 1 }, buy: { 'council:service-contract': 1 } },
